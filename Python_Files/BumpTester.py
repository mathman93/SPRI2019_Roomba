...
def BumpAngle(bumper, l_bumper):
	if bumper == 1 or bumper == 3: # If bumped on right or center...
		if l_bumper == 23: # If L, FL, CL, FR light sensors triggered...
			return 10
		elif l_bumper == 22: # If FL, CL, FR light sensors triggered...
			return 20
		elif l_bumper == 44 or l_bumper == 60: # If FL, CL, R or FL, CL, FR, R light sensors triggered...
			return 30
		elif l_bumper == 12 or l_bumper == 28: # If CL, CR or CL, CR, FR light sensors triggered...
			return 40
