''' IMUSpinChange.py
Purpose: Change movement while robot is moving using orientation from the IMU
...
# Variables and Constants
y_position_enc = 0 # Position of Roomba along y-axis (in mm) according to encoders
...
average_theta = theta # Total average change in rotation
...
while True: #Loop that asks for initial goal x and y coordinates
	try:
